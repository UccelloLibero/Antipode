...
following considerations are intended to help you understand the
license in question.

1. Considerations for licensors: Our public licenses are
...
2. Considerations for the public: By using one of our public
...
Attribution-NoDerivs 4.0 International Public License ("Public
...
technical modifications necessary to do so. The Licensor waives and/
or agrees not to assert any right or authority to forbid You from
...
provided You do not produce Adapted Material;
...
noninfringement, absence of latent or other defects, accuracy, or
